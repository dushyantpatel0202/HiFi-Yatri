...
#BusTracking #RaipurBus #RouteInfo`;
    ...
    return results;
		...
		function applyLanguage() {
			...
			// Re-render Yatra packages when language changes
			if (window._yatraLoaded && _yatraPackages.length) {
				var _activeFilter = document.querySelector('#categoryFilter .filter-btn.active');
				var _activeCat = _activeFilter ? _activeFilter.dataset.category : 'all';
				yatraRenderFilters(_yatraPackages, _activeCat);
				yatraRenderCards(_yatraPackages, _activeCat);
			}
		}

		languageSelectEl.addEventListener("change", () => {
			currentLanguage = languageSelectEl.value;
			window._currentLang = currentLanguage;
			applyLanguage();
		});
...
var YATRA_HI = {
    ...
    9: {
        title: "मनाली कसोल रोहतांग / सिस्सू अटल टनल",
        location: "रायपुर → मनाली → कसोल → रायपुर",
        category_display: "हिल स्टेशन",
        highlights: ["रोहतांग पास / सिस्सू", "अटल टनल", "कसोल कैंप", "कुल्लू राफ्टिंग"],
        hero_title: "मनाली · कसोल · रोहतांग",
        hero_sub: "8 दिन पहाड़ों का जादू",
        hero_meta: "8 दिन · 7 रातें · रायपुर प्रस्थान · 3rd AC ट्रेन",
        hero_tags: ["बर्फ एडवेंचर", "रोहतांग पास", "कसोल कैंप", "DJ और बोनफायर"],
        vibe: { label: "यात्रा का अनुभव", title: "बर्फीली चोटियां और", title_em: "पहाड़ों की आत्मा", desc: "रोहतांग पास की बर्फीली ऊंचाइयों से लेकर कसोल के बोहेमियन कैंपों तक, यह 8 दिन की यात्रा हिमाचल के सर्वश्रेष्ठ को कवर करती है। नदी राफ्टिंग, DJ रातें, बोनफायर डिनर और पहाड़ों के शानदार नज़ारे – हर दिन एक रोमांच है।", items: [{icon:"🏔️",text:"रोहतांग बर्फ का मज़ा"},{icon:"🏕️",text:"कसोल कैंप की रातें"},{icon:"🎿",text:"स्कीइंग और बर्फ पोशाक"},{icon:"🔥",text:"DJ नाइट और बोनफायर"}] },
        itin: { label: "यात्रा का सफर", title: "8 दिन का कार्यक्रम", itinerary: [{day:"दिन 1",title:"रायपुर से दिल्ली",desc:"रायपुर से दिल्ली के लिए 3rd AC कोच ट्रेन से रवाना, रातभर की यात्रा।"},{day:"दिन 2",title:"दिल्ली से मनाली",desc:"सुबह/शाम दिल्ली पहुंचें। सुबह आने पर अपने खर्च पर कुछ घंटे दिल्ली में रुकें। रात 7 बजे दिल्ली से मनाली के लिए ओवरनाइट वोल्वो बस।"},{day:"दिन 3",title:"मनाली दर्शन",desc:"दोपहर तक मनाली पहुंचें। होटल चेक इन, फ्रेश होकर लंच। वशिष्ट मंदिर, जोगिनी वॉटरफॉल और मॉल रोड जाएं। शाम मॉल रोड पर खरीदारी। DJ नाइट और बोनफायर डिनर।"},{day:"दिन 4",title:"रोहतांग पास / सिस्सू और अटल टनल",desc:"सुबह नाश्ते के बाद रोहतांग पास/सिस्सू रवाना। ज़िपलाइन, याक राइड, बंजी, स्कीइंग, ट्यूब और बर्फ पोशाक का मज़ा। अटल टनल देखते हुए मनाली वापस। DJ नाइट और डिनर।"},{day:"दिन 5",title:"कुल्लू राफ्टिंग · हडिंबा मंदिर · कसोल",desc:"सुबह जल्दी उठें, नाश्ता करके होटल चेकआउट। हडिंबा मंदिर, वन विहार और तिब्बती मठ देखें। कुल्लू जाकर राफ्टिंग का मज़ा लें, फिर कसोल कैंप में चेक इन। DJ नाइट, बोनफायर और डिनर।"},{day:"दिन 6",title:"मणिकरण और कसोल दर्शन से दिल्ली",desc:"उठकर नाश्ता करें और कैंप चेकआउट। मणिकरण गुरुद्वारा, कसोल शिव मंदिर, नेचर पार्क कसोल, चालाल ब्रिज, पार्वती नदी और स्थानीय कैफे देखें। फिर दिल्ली के लिए ओवरनाइट रवाना।"},{day:"दिन 7",title:"दिल्ली से रायपुर",desc:"सुबह दिल्ली पहुंचें और ट्रेन समय के अनुसार रायपुर के लिए रवाना।"},{day:"दिन 8",title:"रायपुर पहुंचना",desc:"ट्रेन समय के अनुसार सुबह/दोपहर रायपुर पहुंचें।"}] },
        trans: { label: "हमारा सफर", title: "ट्रेन + वोल्वो बस", desc: "रायपुर से दिल्ली तक आरामदायक 3rd AC ट्रेन, फिर मनाली के लिए वोल्वो बस। वापसी भी इसी तरह।", transport: [{icon:"🚂",name:"3rd AC ट्रेन",detail:"रायपुर ↔ दिल्ली, रातभर की यात्रा"},{icon:"🚌",name:"वोल्वो बस",detail:"दिल्ली → मनाली, रात 7 बजे ओवरनाइट"},{icon:"🚐",name:"लोकल टेम्पो/SUV",detail:"मनाली और कसोल में दर्शनीय स्थल ट्रांसफर"}] },
        pricing: { label: "पैकेज लागत", headline: "कीमत के लिए संपर्क करें", amount: "संपर्क करें", per: "प्रति व्यक्ति", pitch: "रहने, यातायात और गाइडेड दर्शन के साथ किफायती ग्रुप पैकेज।", includes: ["3rd AC ट्रेन टिकट (रायपुर–दिल्ली–रायपुर)","वोल्वो बस (दिल्ली–मनाली–दिल्ली)","मनाली में होटल (2 रातें)","कसोल में कैंप (1 रात)","दर्शनीय स्थल ट्रांसफर","DJ रातें और बोनफायर डिनर"] },
        squad: { badge: "ग्रुप ट्रैवल", title: "ग्रुप एडवेंचर का इंतज़ार है", desc: "दोस्तों और परिवारों के ग्रुप के लिए बेस्ट। अकेले यात्री भी बैच में शामिल हो सकते हैं!" },
        cta: { text: "अपनी सीट बुक करें", sub: "अपनी सीट रिज़र्व करने के लिए संपर्क करें" },
        footer: { tagline: "जहाँ पहाड़ बुलाते हैं और बर्फ जवाब देती है", chips: ["हिल स्टेशन","8 दिन","मनाली-कसोल","रायपुर प्रस्थान"] }
    },
    10: {
        title: "कश्मीर – श्रीनगर · सोनमर्ग · गुलमर्ग · पहलगाम",
        location: "रायपुर → कश्मीर → रायपुर",
        category_display: "हिल स्टेशन",
        highlights: ["डल झील शिकारा राइड", "गुलमर्ग गोंडोला", "सोनमर्ग भ्रमण", "पहलगाम घाटी"],
        hero_title: "कश्मीर",
        hero_sub: "धरती का स्वर्ग",
        hero_meta: "9 दिन · 8 रातें · रायपुर से रायपुर · ₹21,499 से",
        hero_tags: ["हाउसबोट स्टे", "गुलमर्ग गोंडोला", "शिकारा राइड", "बर्फ और घाटियां"],
        vibe: { label: "यात्रा का अनुभव", title: "धरती का स्वर्ग —", title_em: "कश्मीर इंतज़ार कर रहा है", desc: "डल झील पर हाउसबोट में तैरते हुए हिमालय के पीछे सूरज को डूबते देखें। गुलमर्ग गोंडोला पर बर्फ से ढकी दुनिया तक पहुंचें। पहलगाम के केसर के खेतों में घूमें और सोनमर्ग की ताजी पहाड़ी हवा में सांस लें। कश्मीर सिर्फ एक जगह नहीं – यह एक एहसास है।", items: [{icon:"🛶",text:"डल झील शिकारा राइड"},{icon:"🚡",text:"गुलमर्ग गोंडोला फेज 1"},{icon:"🏔️",text:"सोनमर्ग – सोने का मैदान"},{icon:"🌸",text:"पहलगाम – चरवाहों की घाटी"}] },
        itin: { label: "यात्रा का सफर", title: "9 दिन कश्मीर कार्यक्रम", itinerary: [{day:"दिन 1",title:"रायपुर से दिल्ली",desc:"रायपुर से दिल्ली के लिए 3rd AC कोच ट्रेन से रवाना, रातभर की यात्रा।"},{day:"दिन 2",title:"दिल्ली से जम्मू",desc:"सुबह/शाम दिल्ली पहुंचें। रात को जम्मू के लिए रवाना। सुबह आने पर अपने खर्च पर कुछ घंटे दिल्ली में रुकें।"},{day:"दिन 3",title:"जम्मू से श्रीनगर",desc:"जम्मू आगमन – जम्मू-कश्मीर का उत्तरी छोर और शीतकालीन राजधानी। ड्राइवर श्रीनगर ले जाएगा। होटल चेक इन।"},{day:"दिन 4",title:"सोनमर्ग दिवस भ्रमण",desc:"सोनमर्ग – 'सोने का मैदान' – का पूरे दिन का भ्रमण। थजीवास ग्लेशियर तक टट्टू सवारी (अपने खर्च पर), जीरो पॉइंट/ज़ोजिला (अपने खर्च पर)। शाम को श्रीनगर वापस।"},{day:"दिन 5",title:"गुलमर्ग भ्रमण",desc:"नाश्ते के बाद गुलमर्ग जाएं – दुनिया के सबसे सुंदर हिल स्टेशनों में से एक। गोंडोला राइड फेज 1 (कांग्डूरी शामिल)। बर्फ का आनंद। शाम को श्रीनगर होटल में वापस।"},{day:"दिन 6",title:"श्रीनगर दर्शन से पहलगाम",desc:"नाश्ते के बाद सिटी टूर – शंकराचार्य मंदिर, मुगल बाग: चश्माशाही, निशात और शालीमार, ट्यूलिप गार्डन। फिर पहलगाम रवाना। होटल चेक इन।"},{day:"दिन 7",title:"पहलगाम दर्शन से जम्मू से दिल्ली",desc:"नाश्ते के बाद पहलगाम दर्शन। पम्पोर के केसर खेत, अवंतीपुरा खंडहर, मार्तंड सूर्य मंदिर। लिद्दर नदी। अरू वैली, बेताब वैली (अपने खर्च पर)। शाम को जम्मू, फिर दिल्ली।"},{day:"दिन 8",title:"दिल्ली से रायपुर",desc:"दिल्ली पहुंचें और ट्रेन समय के अनुसार रायपुर के लिए रवाना।"},{day:"दिन 9",title:"रायपुर पहुंचना",desc:"रायपुर वापस आएं – घर जैसा कोई स्थान नहीं, कश्मीर की यादों के साथ।"}] },
        trans: { label: "हमारा सफर", title: "ट्रेन + सड़क ट्रांसफर", desc: "रायपुर से दिल्ली तक 3rd AC ट्रेन, फिर सड़क मार्ग से जम्मू और कश्मीर। सभी दर्शन प्राइवेट कैब से।", transport: [{icon:"🚂",name:"3rd AC ट्रेन",detail:"रायपुर ↔ दिल्ली, रातभर की यात्रा"},{icon:"🚐",name:"प्राइवेट कैब",detail:"दिल्ली → जम्मू → श्रीनगर और सभी दर्शन"},{icon:"🛶",name:"शिकारा राइड",detail:"डल झील पर 2 घंटे की शिकारा राइड, शामिल"}] },
        pricing: { label: "पैकेज लागत", headline: "₹21,499 से शुरू", amount: "₹21,499", per: "प्रति व्यक्ति", pitch: "रायपुर से रायपुर सर्व-समावेशी। ट्रिपल शेयरिंग ₹21,500 | डबल शेयरिंग ₹23,500।", includes: ["3rd AC ट्रेन टिकट (रायपुर–दिल्ली–रायपुर)","सभी सड़क ट्रांसफर और दर्शन कैब","3-स्टार होटल","हाउसबोट स्टे","4 नाश्ते + 4 डिनर","गोंडोला राइड फेज 1","पहलगाम यूनियन कैब","शिकारा राइड – 2 घंटे","सभी टैक्स और टोल","ड्राइवर भत्ता"] },
        squad: { badge: "ग्रुप ट्रैवल", title: "ग्रुप और परिवार के लिए", desc: "परिवारों, जोड़ों और दोस्तों के ग्रुप के लिए उत्तम। ट्रिपल और डबल शेयरिंग विकल्प उपलब्ध।" },
        cta: { text: "अपनी सीट बुक करें", sub: "अपनी सीट रिज़र्व करने के लिए संपर्क करें" },
        footer: { tagline: "जहाँ हर नज़ारा एक पोस्टकार्ड है", chips: ["हिल स्टेशन","9 दिन","कश्मीर","₹21,499 से"] }
    },
    11: {
        title: "बस्तर मॉनसून ट्रिप – लॉन्ग वीकेंड",
        location: "रायपुर → बस्तर → रायपुर",
        category_display: "वीकेंड ट्रिप",
        highlights: ["केशकाल सर्किट", "तीरथगढ़ सर्किट", "दंतेवाड़ा सर्किट", "चित्रकोट सर्किट"],
        hero_title: "बस्तर मॉनसून ट्रिप",
        hero_sub: "लॉन्ग वीकेंड एस्केप",
        hero_meta: "3 दिन · 26–28 जून 2026 · रायपुर से रायपुर · ग्रुप टूर",
        hero_tags: ["झरने", "प्राकृतिक सौंदर्य", "संस्कृति और विरासत", "ग्रुप टूर"],
        vibe: { label: "यात्रा का अनुभव", title: "भागो। खोजो।", title_em: "इस मॉनसून बस्तर का अनुभव लो!", desc: "मॉनसून में बस्तर शुद्ध जादू है – गर्जना करते झरने, हरे-भरे जंगल, प्राचीन मंदिर और जनजातीय संस्कृति। यह 3 दिन का लॉन्ग वीकेंड ट्रिप ग्रुप टूर के आराम से बस्तर के सर्वश्रेष्ठ सर्किट से होकर जाता है।", items: [{icon:"🌊",text:"चित्रकोट – भारत का नियाग्रा"},{icon:"🌿",text:"केशकाल घाटी और घाट"},{icon:"🛕",text:"दंतेवाड़ा मंदिर सर्किट"},{icon:"💦",text:"तीरथगढ़ जलप्रपात"}] },
        itin: { label: "यात्रा का सफर", title: "3 दिन बस्तर कार्यक्रम", itinerary: [{day:"दिन 1 – शुक्रवार, 26 जून",title:"रायपुर से बस्तर – केशकाल और तीरथगढ़ सर्किट",desc:"रायपुर से सुबह जल्दी रवाना। रास्ते में केशकाल घाटी के घुमावदार घाट और हरी-भरी घाटियां देखें। तीरथगढ़ जलप्रपात – बस्तर का एक बेहद खूबसूरत झरना। होटल चेक इन, डिनर।"},{day:"दिन 2 – शनिवार, 27 जून",title:"दंतेवाड़ा सर्किट और चित्रकोट",desc:"नाश्ते के बाद दंतेवाड़ा सर्किट – भारत के 52 शक्तिपीठों में से एक प्रसिद्ध दंतेश्वरी मंदिर। फिर चित्रकोट – भारत का सबसे चौड़ा झरना, मॉनसून में बेहद शानदार। रात्रि विश्राम।"},{day:"दिन 3 – रविवार, 28 जून",title:"रायपुर वापसी",desc:"नाश्ते के बाद चेकआउट और रायपुर वापसी की यात्रा। रास्ते में स्थानीय स्थल देखें। शाम तक रायपुर पहुंचें, जीवन भर की यादों के साथ।"}] },
        trans: { label: "हमारा सफर", title: "ग्रुप यातायात", desc: "रायपुर से आरामदायक ग्रुप ट्रांसपोर्ट। आराम से बैठें और मॉनसून के नज़ारे देखें।", transport: [{icon:"🚌",name:"ग्रुप बस / टेम्पो ट्रैवलर",detail:"रायपुर पिकअप और ड्रॉप, सभी दर्शन ट्रांसफर"},{icon:"🏨",name:"होटल स्टे",detail:"2 रातें रहना शामिल"},{icon:"🍽️",name:"भोजन",detail:"कार्यक्रम के अनुसार भोजन शामिल"}] },
        pricing: { label: "पैकेज लागत", headline: "कीमत के लिए संपर्क करें", amount: "संपर्क करें", per: "प्रति व्यक्ति", pitch: "सर्व-समावेशी ग्रुप टूर। प्राकृतिक सौंदर्य, संस्कृति और विरासत – जीवन भर की यादें।", includes: ["यातायात (रायपुर से रायपुर)","2 रातें होटल","कार्यक्रम के अनुसार भोजन","सभी सर्किट में दर्शन","टूर गाइड"] },
        squad: { badge: "ग्रुप टूर", title: "ग्रुप मॉनसून गेटअवे", desc: "दोस्तों, परिवारों और अकेले यात्रियों के लिए मज़ेदार ग्रुप ट्रिप। बैच में शामिल हों!" },
        cta: { text: "अपनी सीट बुक करें", sub: "26–28 जून 2026 · शुक्रवार से रविवार · सीमित सीटें" },
        footer: { tagline: "प्राकृतिक सौंदर्य · संस्कृति और विरासत · जीवन भर की यादें", chips: ["वीकेंड ट्रिप","3 दिन","बस्तर","मॉनसून"] }
    },
    12: {
        title: "बस्तर मॉनसून एक्सपीडिशन 2026",
        location: "रायपुर → बस्तर → रायपुर",
        category_display: "वीकेंड ट्रिप",
        highlights: ["केशकाल घाटी और तातामारी व्यू पॉइंट", "कांगेर वैली राष्ट्रीय उद्यान", "तीरथगढ़ जलप्रपात", "चित्रकोट – भारत का नियाग्रा"],
        hero_title: "बस्तर मॉनसून एक्सपीडिशन 2026",
        hero_sub: "जहाँ प्रकृति विरासत से मिलती है",
        hero_meta: "3 दिन · 2 रातें · 26–28 जून 2026 · रायपुर से रायपुर · ₹9,500 से",
        hero_tags: ["चित्रकोट जलप्रपात", "कांगेर वैली", "जनजातीय विरासत", "मॉनसून का जादू"],
        vibe: { label: "यात्रा का अनुभव", title: "अछूती सुंदरता,", title_em: "जादुई मॉनसून", desc: "बस्तर के मनमोहक परिदृश्य, भव्य जलप्रपात, प्राचीन मंदिर, जनजातीय कला और समृद्ध सांस्कृतिक विरासत की खोज करें। अकेले यात्रियों, जोड़ों, परिवारों और ग्रुप – सभी के लिए यह 3 दिन / 2 रातें का अनुभव छत्तीसगढ़ के सबसे प्रतिष्ठित स्थलों से होकर जाता है।", items: [{icon:"🌊",text:"चित्रकोट – भारत का नियाग्रा"},{icon:"🌿",text:"कांगेर वैली राष्ट्रीय उद्यान"},{icon:"🛕",text:"माँ दंतेश्वरी मंदिर"},{icon:"🎨",text:"ढोकरा कला और जनजातीय संस्कृति"}] },
        itin: { label: "यात्रा का सफर", title: "3 दिन का कार्यक्रम", itinerary: [{day:"दिन 1",title:"रायपुर – केशकाल – कोंडागांव",desc:"सुबह 7:30 बजे रायपुर से रवाना। रास्ते में नाश्ता। केशकाल घाटी, तातामारी व्यू पॉइंट, प्राचीन शिव मंदिर, कुयेमारी जलप्रपात, ढोकरा आर्ट सेंटर और शबरी एम्पोरियम जाएं। लंच। कोंडागांव में रात्रि विश्राम।"},{day:"दिन 2",title:"कोंडागांव – कांगेर वैली – दंतेवाड़ा",desc:"सुबह 7:30 बजे दंतेवाड़ा के लिए रवाना। नाश्ता। कांगेर वैली राष्ट्रीय उद्यान, तीरथगढ़ जलप्रपात देखें। लंच। माँ दंतेश्वरी मंदिर दर्शन। दंतेवाड़ा में रात्रि विश्राम।"},{day:"दिन 3",title:"दंतेवाड़ा – बारसूर – चित्रकोट – रायपुर",desc:"नाश्ता। बारसूर हेरिटेज वॉक और प्राचीन मंदिर। मेंद्री घुमर जलप्रपात और व्यू पॉइंट। चित्रकोट जलप्रपात – भारत का नियाग्रा। लंच। रायपुर के लिए रवाना। रात 9 बजे रायपुर पहुंचना।"}] },
        trans: { label: "हमारा सफर", title: "AC यातायात – रायपुर से रायपुर", desc: "रायपुर से पूरी तरह वातानुकूलित वाहन। सभी दर्शन ट्रांसफर शामिल।", transport: [{icon:"🚌",name:"AC यातायात",detail:"रायपुर से रायपुर, सभी दर्शन शामिल"},{icon:"🏨",name:"होटल स्टे",detail:"शेयरिंग आधार पर 2 रातें"},{icon:"🍽️",name:"भोजन",detail:"3 नाश्ते, 3 लंच, 2 डिनर"}] },
        pricing: { label: "पैकेज लागत", headline: "₹9,500 प्रति व्यक्ति से", amount: "₹9,500", per: "प्रति व्यक्ति (ट्रिपल शेयरिंग)", pitch: "रायपुर से रायपुर सर्व-समावेशी। कपल पैकेज भी उपलब्ध।", includes: ["होटल (शेयरिंग आधार पर)","3 नाश्ते, 3 लंच, 2 डिनर","AC यातायात (रायपुर से रायपुर) + दर्शन","स्टोरीटेलिंग अनुभव","प्रोफेशनल टूर गाइड","प्रवेश शुल्क, टोल और पार्किंग"] },
        squad: { badge: "ग्रुप टूर", title: "अकेले, जोड़े, परिवार और ग्रुप", desc: "अकेले यात्रियों, जोड़ों, परिवारों, ग्रुप और कॉर्पोरेट टीम के लिए उपयुक्त।" },
        cta: { text: "अपनी सीट बुक करें", sub: "26–28 जून 2026 · ट्रिपल ₹9,500 · कपल ₹9,999 · सीमित सीटें" },
        footer: { tagline: "जादुई मॉनसून में बस्तर की अछूती सुंदरता की खोज करें।", chips: ["वीकेंड ट्रिप","3 दिन","बस्तर","₹9,500"] }
    }
};
...
function yatraHindiPkg(p) {
    ...
    ['hero_title','hero_sub','hero_meta','category_display','hero_tags','title','location','highlights'].forEach(function(k) {
...
function yatraRenderFilters(packages, activeCategory) {
    ...
    var _isHi = (window._currentLang === 'hi');
    const labels = _isHi ? {
        all:          'सभी पैकेज',
        road_trip:    '🚗 रोड ट्रिप',
        tirth_yatra:  '🛕 तीर्थ यात्रा',
        honeymoon:    '💑 हनीमून',
        trekking:     '🥾 ट्रेकिंग',
        regional:     '🏞️ क्षेत्रीय',
        wildlife:     '🐘 वन्यजीव',
        beach:        '🏖️ बीच',
        solo_travel:  '🧍 सोलो ट्रैवल',
        hill_station: '🏔️ हिल स्टेशन',
        weekend_trip: '🌿 वीकेंड ट्रिप'
    } : {
        all:          'All Packages',
...
function yatraRenderCards(packages, category, userLoc) {
    ...
    var _cardIsHi = (window._currentLang === 'hi');
    var _waText = _cardIsHi ? 'व्हाट्सएप पर बुक करें' : 'Book via WhatsApp';
    var _detailText = _cardIsHi ? '🔍 विवरण' : '🔍 Details';

    grid.innerHTML = list.map(function(pkg) {
        var displayPkg = _cardIsHi ? yatraHindiPkg(pkg) : pkg;
        var nearBadge = '';
        ...
        return `<div class="package-card">
            <div class="card-image" style="background-image:url('${pkg.image}')">
                <span class="category-badge">${displayPkg.category_display}</span>
                ${statusBadge}
                ${cardShareBtn}
                ${priceBadgeHtml}
            </div>
            <div class="card-content">
                ${providerBadge}
                <h3 class="package-title">${displayPkg.title}</h3>
                <div class="package-location"><i class="fas fa-map-marker-alt"></i> ${displayPkg.location}</div>
                ${nearBadge}
                ...
                <div class="package-highlights">${displayPkg.highlights.map(function(h) { return `<span class="highlight-tag">${h}</span>`; }).join('')}</div>
                <div class="card-actions">
                    <button class="whatsapp-btn" data-wa="${pkg.whatsapp_number || '917734906606'}" data-title="${pkg.title}">
                        <i class="fab fa-whatsapp"></i> ${_waText}
                    </button>
                    <button class="detail-btn" data-id="${pkg.id}">${_detailText}</button>
                </div>
            </div>
        </div>`;
    }).join('');
